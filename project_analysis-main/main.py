...
.planet.red { background: #ff4d4d; width: 25px; height: 25px; animation-duration: 15s; }
.planet.blue { background: #3399ff; width: 15px; height: 15px; animation-duration: 8s; }
...
components.html(html_code, height=600, width=600)
# -------------------------------------------------------------------
# USER DATABASE
# -------------------------------------------------------------------
